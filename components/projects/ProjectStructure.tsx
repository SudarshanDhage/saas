...
import { Feature, Project } from '@/lib/firestore-v2'
    ...
    <Card className="w-full">
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-xl text-slate-900 dark:text-white">{projectData.title}</CardTitle>
      ...
      <CardContent>
        <div className="flex flex-col md:flex-row gap-6">
          {/* Core Features */}
          <div 
            className="flex-1 border border-slate-200 dark:border-slate-700 rounded-lg p-4 bg-white dark:bg-gray-800"
            onDragOver={handleDragOver}
            onDrop={handleDropOnCore}
          >
            <h3 className="text-md font-semibold text-slate-900 dark:text-white mb-3">Core Features</h3>
          ...
          >
            <div className="flex justify-between items-center mb-3">
              <h3 className="text-md font-semibold text-slate-900 dark:text-white">Suggested Features</h3>
              <Button 
                variant="outline" 
                size="sm"
